...
function Filters({filterName, houseFilter,handleFilterName,handleChangeHouseFilter}) {
  return (
    <form className="form__container">
        ...
        <FilterHouse
        handleChangeHouseFilter={handleChangeHouseFilter} houseFilter={houseFilter}
        />
        </form>
  );
}
